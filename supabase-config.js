...
var TRANSLATIONS = {
  th: {
    ...
    todayExpense: '❤️ รายจ่ายวันนี้',
    monthBalance: '💜 คงเหลือเดือนนี้',
    quickAdd: '⚡ บันทึกด่วน (รายการโปรด)',
    thisMonth: 'เดือนนี้',
    thisYear: 'ปีนี้',
    custom: 'กำหนดเอง',
    incomeVsExpense: 'รายรับ vs รายจ่าย (6 เดือน)',
    dailyExpense: '📅 รายจ่ายรายวัน (เดือนนี้)',
    expenseByCategory: 'รายจ่ายตามหมวดหมู่',
    monthCompare: '📊 เปรียบเทียบเดือนต่อเดือน',
    recentTx: 'รายการล่าสุด',
    viewAll: 'ดูทั้งหมด →',
    savingsGoal: '🎯 เป้าหมายการออม',
    addGoal: '+ เพิ่ม',
    budgetStatus: 'สถานะงบประมาณ',
    upcomingDebts: '⚠️ หนี้ใกล้ครบกำหนด',
    date: 'วันที่',
    description: 'รายการ',
    amount: 'จำนวน',
    noData: 'ไม่มีข้อมูล',
  ...
  lo: {
    ...
    todayExpense: '❤️ ລາຍຈ່າຍມື້ນີ້',
    monthBalance: '💜 ຍອດຄົງເຫຼືອເດືອນນີ້',
    quickAdd: '⚡ ບັນທຶກດ່ວນ (ລາຍການໂປດ)',
    thisMonth: 'ເດືອນນີ້',
    thisYear: 'ປີນີ້',
    custom: 'ກຳນົດເອງ',
    incomeVsExpense: 'ລາຍຮັບ vs ລາຍຈ່າຍ (6 ເດືອນ)',
    dailyExpense: '📅 ລາຍຈ່າຍລາຍວັນ (ເດືອນນີ້)',
    expenseByCategory: 'ລາຍຈ່າຍຕາມໝວດໝູ່',
    monthCompare: '📊 ປຽບທຽບເດືອນຕໍ່ເດືອນ',
    recentTx: 'ລາຍການລ່າສຸດ',
    viewAll: 'ເບິ່ງທັງໝົດ →',
    savingsGoal: '🎯 ເປົ້າໝາຍການອອມ',
    addGoal: '+ ເພີ່ມ',
    budgetStatus: 'ສະຖານະງົບປະມານ',
    upcomingDebts: '⚠️ ໜີ້ໃກ້ຄົບກຳນົດ',
    date: 'ວັນທີ',
    description: 'ລາຍການ',
    amount: 'ຈຳນວນ',
    noData: 'ບໍ່ມີຂໍ້ມູນ',
  ...
  en: {
    ...
    todayExpense: '❤️ Today Expense',
    monthBalance: '💜 Month Balance',
    quickAdd: '⚡ Quick Add (Favorites)',
    thisMonth: 'This Month',
    thisYear: 'This Year',
    custom: 'Custom',
    incomeVsExpense: 'Income vs Expense (6 Months)',
    dailyExpense: '📅 Daily Expense (This Month)',
    expenseByCategory: 'Expense by Category',
    monthCompare: '📊 Month-over-Month',
    recentTx: 'Recent Transactions',
    viewAll: 'View All →',
    savingsGoal: '🎯 Savings Goals',
    addGoal: '+ Add',
    budgetStatus: 'Budget Status',
    upcomingDebts: '⚠️ Upcoming Debts',
    date: 'Date',
    description: 'Description',
    amount: 'Amount',
    noData: 'No Data',
